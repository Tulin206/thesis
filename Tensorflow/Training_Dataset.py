...
def load_training_data(array_of_speak,
    ...
    # scaled_data = scaler.fit_transform(array_of_speak)
    # print(scaled_data[0])
    ...
    # Specify the full path to the directory and the filename
    output_directory = '/mnt/ceph/tco/TCO-Students/Homes/ISRAT/'
    output_filename = f'Raw_file_{sample_number}.txt'

    # Save transposed_array_of_speak[0] to the specified directory
    np.savetxt(output_directory + output_filename, transposed_array_of_speak[0], fmt='%.8f')
    ...
    # Specify the full path to the directory and the filename
    output_directory = '/mnt/ceph/tco/TCO-Students/Homes/ISRAT/'
    output_filename = f'StandardScaled_file_{sample_number}.txt'
...
# function calling
load_training_data(t22, training22, t22_tr, training_set_2, np_tarray_2, str, 2)
...
# function calling
load_training_data(t23, training23, t23_tr, training_set_3, np_tarray_3, str, 3)
...
# function calling
load_training_data(t25, training25, t25_tr, training_set_4, np_tarray_4, str, 4)
...
# function calling
load_training_data(t28, training28, t28_tr, training_set_5, np_tarray_5, str, 5)
...
# function calling
load_training_data(t29, training29, t29_tr, training_set_6, np_tarray_6, str, 6)
...
# function calling
load_training_data(t31, training31, t31_tr, training_set_7, np_tarray_7, str, 7)
...
# function calling
load_training_data(t32, training32, t32_tr, training_set_8, np_tarray_8, str, 8)
...
# function calling
load_training_data(t33, training33, t33_tr, training_set_9, np_tarray_9, str, 9)
...
# function calling
load_training_data(t34, training34, t34_tr, training_set_10, np_tarray_10, str, 10)
...
# function calling
load_training_data(t1, training1, t1_tr, training_set_11, np_tarray_1, str, 11)
...
# function calling
load_training_data(t3, training3, t3_tr, training_set_12, np_tarray_12, str, 12)
...
# function calling
load_training_data(t7, training7, t7_tr, training_set_13, np_tarray_13, str, 13)
...
# function calling
load_training_data(t10, training10, t10_tr, training_set_14, np_tarray_14, str, 14)
...
# function calling
load_training_data(t11, training11, t11_tr, training_set_15, np_tarray_15, str, 15)
...
# function calling
load_training_data(t17, training17, t17_tr, training_set_16, np_tarray_16, str, 16)
