...
def load_test_data(array_of_speak,
    ...
    # Reshape input image
    test_set_num = np.reshape(transposed_array_of_speak, (128, 384, 441))
    # # dataset_1 = np.reshape(img_plot, (4, 12, 1024))
    # NumpyArray_of_TestSet = np.array(test_set_num)
    print('After reshaping the image dimension', test_set_num.shape)
...
testdatasets = np.transpose(testdatasets, (0, 3, 1, 2))
