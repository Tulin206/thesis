...
from DataLoad_16_PyTorch import save_plots, TrainDataset, TestDataset, predict_test_data
...
import Training_Dataset_16_PyTorch
...
x = np.array(Training_Dataset_16_PyTorch.datasets)
...
def sk_cv():
    ...
    # return fold_results, test_loaders, valid_labels, test_loader
