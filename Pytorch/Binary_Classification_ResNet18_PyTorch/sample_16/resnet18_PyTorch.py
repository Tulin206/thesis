...
if __name__ == '__main__':
    tensor = torch.rand([1, 441, 128, 384])
    # tensor = torch.rand([1, 1, 128, 384])
    model = ResNet(img_channels=441, num_layers=18, block=BasicBlock, num_classes=1)
    ...
    try:
        summary(model, input_size=(441, 128, 384), device="cpu")
    finally:
        sys.stdout = sys.__stdout__

    # Write the captured summary to a file
    summary_path = '/mnt/ceph/tco/TCO-Students/Homes/ISRAT/PyTorch_ResNet18_model_summary.txt'
