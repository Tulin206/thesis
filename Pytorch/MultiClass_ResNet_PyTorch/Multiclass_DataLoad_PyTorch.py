...
import Multiclass_Training_Dataset_PyTorch
import Multiclass_Test_Dataset_PyTorch
...
x = np.array(Multiclass_Training_Dataset_PyTorch.datasets)
...
test = np.array(Multiclass_Test_Dataset_PyTorch.testdatasets)
...
def get_data(batch_size=1, n_splits=6):
    ...
    # # Define your fold indices manually for stratified k-fold cross validation
    # fold_indices = [
    #     ([1, 3, 6, 7, 8, 12, 14, 15], [0, 2, 4, 5, 9, 10, 11, 13]),
    #     ([0, 2, 4, 5, 9, 10, 11, 13], [1, 3, 6, 7, 8, 12, 14, 15])
    #     # Define indices for the other folds similarly
    #     # ...
    # ]

    # # Define your fold indices manually in a stratified fashion (Ex-1)
    # fold_indices = [
    #     ([4, 11, 1, 13, 15, 3, 6, 5, 14, 2, 0, 9], [7, 8, 10, 12])
    #     # Define indices for the other folds similarly
    #     # ...
    # ]

    # Define your fold indices manually in a stratified fashion (Ex-2)
    # fold_indices = [
        # ([4, 11, 1, 13, 15, 3, 6, 5, 14, 2, 0, 9, 12], [7, 8, 10])
        # Define indices for the other folds similarly
        # ...
    # ]
...
def predict_test_data(model, test_loader, device):
    ...
    print("shape of test_preds_array", test_preds_array.shape)
    print("shape of test_preds_list", np.shape(test_preds_list))
